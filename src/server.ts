...
- avax_metrics_series / avax_metrics_staking / avax_l1_rankings for network stats via SOCI4L (tx, active addresses, fees, TPS, validators, L1 market share & bot-traffic share); avax_metrics_chart to render them as an SVG chart + table
Live data tools (avax_get_*, avax_pchain_*, avax_data_*, avax_metrics_*) are read-only and hit public RPC/Data API endpoints. Workflow tools (avax_plan_l1_launch, avax_generate_genesis, avax_icm_recipe, avax_troubleshoot) compose knowledge into actionable plans. Always cite doc URLs returned by the tools.`,
    }
  );
